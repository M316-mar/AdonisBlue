        ...
        <div className="flex min-w-0 flex-1 items-center gap-2">
          {botLogoImage ? (
            ...
            <img
              src={botLogoImage}
              alt=""
              style={{ width: "80px", height: "80px", minWidth: "80px", borderRadius: "50%", backgroundColor: "white", objectFit: "cover" }}
            />
          ) : (
            <div
        ...
        <div className="mx-auto flex max-w-3xl items-center gap-4 sm:gap-5">
          {botLogoImage ? (
            ...
            <img
              src={botLogoImage}
              alt=""
              style={{ width: "90px", height: "90px", minWidth: "90px", borderRadius: "50%", backgroundColor: "white", objectFit: "cover" }}
            />
          ) : (
            <div
