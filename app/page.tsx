  ...
  return (
    <div className="mx-auto max-w-3xl space-y-3">
      {faqItems.map((item, i) => {
        const isOpen = open === i;
        return (
          <div key={item.q} className="overflow-hidden rounded-2xl border border-white/10 bg-white/5 backdrop-blur-sm transition hover:border-teal-400/30">
            <button type="button" onClick={() => setOpen(isOpen ? null : i)} className="flex w-full items-center justify-between gap-4 px-5 py-4 text-left" aria-expanded={isOpen}>
              ...
              <span className={`flex h-8 w-8 shrink-0 items-center justify-center rounded-full border border-white/20 text-teal-300 transition ${isOpen ? "rotate-180 bg-white/10" : ""}`}>
            ...
            {isOpen && (
              <div className="border-t border-white/10 px-5 pb-4">
                <p className="pt-3 text-sm leading-relaxed text-slate-300">{item.a}</p>
              </div>
            )}
          </div>
        );
...
export default function Home() {
  ...
  return (
    <div className="min-h-full bg-[#0d1628] font-sans text-slate-800 antialiased">
      ...
      {/* ── NAV ── */}
      <header className="sticky top-0 z-50 border-b border-white/10 bg-[#0d1628]/90 backdrop-blur-md">
        <div className="mx-auto flex max-w-6xl items-center justify-between gap-3 px-4 py-3 sm:px-6 lg:px-8 lg:py-4">
          <a href="#" className="flex min-w-0 shrink items-center gap-2">
            ...
            <span className="text-lg font-semibold tracking-tight text-white">AdonisBlue</span>
          </a>
          <nav className="hidden items-center gap-7 lg:flex">
            {["#daily-flow|How it Works","#features|Features","#pricing|Pricing","#faq|FAQ"].map(s => {
              const [href, label] = s.split("|");
              return <a key={label} href={href} className="text-sm font-medium text-slate-300 transition hover:text-teal-300">{label}</a>;
            })}
          </nav>
          <div className="flex items-center gap-2">
            <a href="/auth" className="rounded-full border border-white/20 px-4 py-2 text-sm font-semibold text-white transition hover:border-teal-300 hover:text-teal-300">Log in</a>
            <a href="#pricing" className="rounded-full bg-[#0d9488] px-4 py-2 text-sm font-semibold text-white shadow-lg shadow-teal-900/40 transition hover:bg-teal-600">Get Started</a>
          </div>
        </div>
      </header>
      ...
      <main>
        ...
        <section className="relative overflow-hidden px-4 py-16 sm:px-6 sm:py-20 lg:px-8 lg:py-28">
          ...
          <div className="pointer-events-none absolute inset-0" aria-hidden>
            <div className="absolute -top-32 left-1/2 h-[600px] w-[600px] -translate-x-1/2 rounded-full bg-teal-500/10 blur-[120px]" />
            <div className="absolute bottom-0 left-0 h-[400px] w-[400px] rounded-full bg-sky-500/8 blur-[100px]" />
            <div className="absolute right-0 top-1/2 h-[300px] w-[300px] rounded-full bg-purple-500/8 blur-[80px]" />
          </div>
          ...
          <div className="relative mx-auto grid max-w-6xl gap-12 lg:grid-cols-2 lg:items-center">
            ...
            {/* Chat mockup — liquid glass style */}
              ...
              <div className="relative overflow-hidden rounded-3xl border border-white/15 bg-white/5 shadow-2xl shadow-black/40 backdrop-blur-xl">
                ...
                <div className="space-y-4 px-4 py-5">
                  <div className="flex justify-end">
                    <div className="max-w-[80%] rounded-2xl rounded-br-sm border border-teal-400/30 bg-teal-400/10 px-4 py-2.5 text-sm text-white backdrop-blur-sm">
                  ...
                  <div className="flex justify-start gap-2">
                    ...
                    <div className="max-w-[80%] rounded-2xl rounded-bl-sm border border-white/10 bg-white/8 px-4 py-2.5 text-sm leading-relaxed text-slate-200 backdrop-blur-sm">
                      Great question! Many practices review blood thinners before treatment due to bruising risk. I can send our booking link so your injector can guide you safely 💙
                    </div>
                  </div>
                  <div className="flex justify-end">
                    <div className="max-w-[80%] rounded-2xl rounded-br-sm border border-teal-400/30 bg-teal-400/10 px-4 py-2.5 text-sm text-white backdrop-blur-sm">
                  ...
                  <div className="flex justify-start gap-2">
                    <div className="flex h-7 w-7 shrink-0 items-center justify-center rounded-full bg-white/10 text-xs">🤍</div>
                    <div className="max-w-[80%] rounded-2xl rounded-bl-sm border border-white/10 bg-white/8 px-4 py-2.5 text-sm leading-relaxed text-slate-200 backdrop-blur-sm">
                      Pricing is personalized to exactly what you need — your nurse will go over everything at your appointment. Most clients are genuinely surprised by how reasonable it is! Ready to grab a spot? 💕
                    </div>
                  </div>
                </div>
                {/* Quick replies */}
        ...
        {/* ── STATS BAR ── */}
        <section className="border-y border-white/8 bg-white/3 px-4 py-10 sm:px-6 lg:px-8 backdrop-blur-sm">
          <div className="mx-auto max-w-6xl">
            <div className="grid grid-cols-2 gap-6 lg:grid-cols-4">
              {[
                { stat: "24/7", label: "Client coverage", icon: "🌙" },
                { stat: "5 min", label: "Setup time", icon: "⚡" },
                { stat: "2×", label: "More bookings", icon: "📈" },
                { stat: "0", label: "Missed questions", icon: "✅" },
              ].map((item) => (
                <div key={item.label} className="group relative overflow-hidden rounded-2xl border border-white/10 bg-white/5 p-5 text-center backdrop-blur-sm transition hover:border-teal-400/30 hover:bg-white/8">
                  <div className="absolute inset-0 bg-gradient-to-br from-teal-400/5 to-transparent opacity-0 transition group-hover:opacity-100" aria-hidden />
                  <p className="text-3xl font-bold text-teal-300 sm:text-4xl">{item.stat}</p>
                  <p className="mt-1 text-sm font-medium text-slate-400">{item.icon} {item.label}</p>
                </div>
              ))}
            </div>
          </div>
        ...
        {/* ── HOW IT WORKS ── */}
        <section id="daily-flow" className="px-4 py-16 sm:px-6 sm:py-20 lg:px-8 lg:py-24">
          <div className="mx-auto max-w-6xl">
            <div className="mx-auto max-w-2xl text-center">
              <p className="text-xs font-semibold uppercase tracking-widest text-teal-400">Daily operations</p>
              <h2 className="mt-3 text-3xl font-bold tracking-tight text-white sm:text-4xl">How AdonisBlue runs your front desk</h2>
              <p className="mt-4 text-base leading-relaxed text-slate-400">A clean workflow that keeps response times fast and handoffs clear.</p>
            </div>
            <div className="mt-12 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
              {[
                { step:"01", title:"Client asks a question", body:"DM, text, or website chat.", icon:"💬" },
                { step:"02", title:"AdonisBlue answers instantly", body:"Plain-language reply in English or Spanish.", icon:"⚡" },
                { step:"03", title:"Complex questions forwarded", body:"Anything sensitive routes to you.", icon:"🔀" },
                { step:"04", title:"Nurse gets notified", body:"You follow up with context, not chaos.", icon:"🔔" },
              ].map((card, i) => (
                <div key={card.step} className="group relative overflow-hidden rounded-2xl border border-white/10 bg-white/5 p-6 backdrop-blur-sm transition hover:border-teal-400/30">
                  <div className="absolute inset-0 bg-gradient-to-br from-teal-400/8 via-transparent to-transparent opacity-0 transition group-hover:opacity-100" aria-hidden />
                  <div className="relative">
                    <div className="mb-4 flex items-center justify-between">
                      <span className="text-2xl">{card.icon}</span>
                      <span className="text-xs font-bold text-teal-400/60">{card.step}</span>
                    </div>
        ...
        <section id="features" className="relative overflow-hidden px-4 py-16 sm:px-6 sm:py-20 lg:px-8 lg:py-24">
          <div className="pointer-events-none absolute inset-0" aria-hidden>
            <div className="absolute left-1/4 top-0 h-[500px] w-[500px] rounded-full bg-teal-500/8 blur-[100px]" />
            <div className="absolute bottom-0 right-1/4 h-[400px] w-[400px] rounded-full bg-sky-500/8 blur-[80px]" />
          </div>
          <div className="relative mx-auto max-w-6xl">
            <div className="max-w-2xl">
              <p className="text-xs font-semibold uppercase tracking-widest text-teal-400">Features</p>
              <h2 className="mt-3 text-3xl font-bold tracking-tight text-white sm:text-4xl">Calm, premium client communication at scale</h2>
              <p className="mt-4 text-base leading-relaxed text-slate-400">Designed to feel elegant on the surface and practical in real clinic life.</p>
            </div>
            <ul className="mt-12 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
              {features.map((feature) => (
                <li key={feature.title} className="group relative overflow-hidden rounded-2xl border border-white/10 bg-white/5 p-6 backdrop-blur-md transition hover:border-teal-400/40 hover:bg-white/8">
                  <div className="absolute inset-0 bg-gradient-to-br from-teal-400/10 via-transparent to-sky-400/5 opacity-0 transition group-hover:opacity-100" aria-hidden />
                  <div className="relative">
        ...
        <section className="px-4 py-16 sm:px-6 sm:py-20 lg:px-8 lg:py-24">
          <div className="mx-auto max-w-6xl">
            <div className="mx-auto max-w-2xl text-center">
              <p className="text-xs font-semibold uppercase tracking-widest text-teal-400">How nurses use it</p>
              <h2 className="mt-3 text-3xl font-bold tracking-tight text-white sm:text-4xl">Meet clients where they already are</h2>
            </div>
            <div className="mt-12 grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
              {[
                { icon:"📱", title:"Share in your Instagram bio", body:"One link handles story replies and DMs while you are in treatment — no more typing the same answers all day." },
                { icon:"🌐", title:"Embed on your website", body:"Visitors get instant answers on your site without waiting for email — so fewer people bounce to a competitor." },
                { icon:"💌", title:"Send directly in a DM or text", body:"Drop your bot link in a message so curious clients get clear answers before they book with someone else." },
              ].map((item) => (
                <div key={item.title} className="group relative overflow-hidden rounded-2xl border border-white/10 bg-white/5 p-7 backdrop-blur-sm transition hover:border-teal-400/30">
                  <div className="absolute inset-0 bg-gradient-to-br from-teal-400/8 to-transparent opacity-0 transition group-hover:opacity-100" aria-hidden />
                  <div className="relative">
        ...
        {/* ── PRICING ── */}
        <section id="pricing" className="relative overflow-hidden px-4 py-16 sm:px-6 sm:py-20 lg:px-8 lg:py-24">
          <div className="pointer-events-none absolute inset-0" aria-hidden>
            <div className="absolute left-1/2 top-1/2 h-[600px] w-[600px] -translate-x-1/2 -translate-y-1/2 rounded-full bg-teal-500/6 blur-[120px]" />
          </div>
          <div className="relative mx-auto max-w-6xl">
            <div className="mx-auto max-w-2xl text-center">
            ...
            <div className="mt-12 grid gap-6 lg:grid-cols-3 lg:items-start">
              ...
              <div className="flex h-full flex-col rounded-2xl border border-white/10 bg-white/5 p-7 backdrop-blur-sm">
                <p className="text-xs font-bold uppercase tracking-widest text-teal-400">14 Days Free</p>
                <h3 className="mt-3 text-xl font-bold text-white">Try it completely free</h3>
                <p className="mt-2 text-sm text-slate-400">No credit card needed. See how many questions your bot answers before you pay a dollar.</p>
                <ul className="mt-6 flex-1 space-y-2.5">
                  {["Your own custom chatbot","Up to 50 client questions","English and Spanish","Share via link or Instagram","Set up in under 5 minutes"].map(l => (
                    <li key={l} className="flex gap-2 text-sm text-slate-300"><span className="text-teal-400">✓</span>{l}</li>
                  ))}
                </ul>
                <a href="/auth" className="mt-8 inline-flex min-h-[48px] w-full items-center justify-center rounded-full bg-white/10 px-5 py-3 text-sm font-semibold text-white border border-white/20 transition hover:bg-white/15">
                  Start Free — No Card Needed
                </a>
              </div>
              {/* Starter */}
              <div className="flex h-full flex-col rounded-2xl border border-white/10 bg-white/5 p-7 backdrop-blur-sm">
                ...
                <a href="/auth" className="mt-8 inline-flex min-h-[48px] w-full items-center justify-center rounded-full bg-white/10 border border-white/20 px-5 py-3 text-sm font-semibold text-white transition hover:bg-white/15">
                  Get Starter
                </a>
              </div>
              {/* Pro — highlighted */}
              <div className="relative flex h-full flex-col overflow-hidden rounded-2xl border border-teal-400/50 bg-gradient-to-b from-teal-400/15 to-teal-400/5 p-7 backdrop-blur-sm shadow-xl shadow-teal-900/20">
                ...
                <div className="relative">
                  ...
                  <p className="mt-2 text-sm text-slate-300">Your AI-powered front desk — for less than one treatment.</p>
                  <ul className="mt-6 flex-1 space-y-2.5">
                    {["Everything in Starter","Custom bot name and colors","Guided setup for every client question","Monthly check-in to improve answers","Conversation insights dashboard","Multiple locations or specialties","VIP 4-hour response for fixes"].map(l => (
                      <li key={l} className="flex gap-2 text-sm text-slate-200"><span className="text-teal-300">✓</span>{l}</li>
                    ))}
                  </ul>
        ...
        <section id="faq" className="px-4 py-16 sm:px-6 sm:py-20 lg:px-8 lg:py-24">
          <div className="mx-auto max-w-6xl">
            <div className="mx-auto max-w-2xl text-center">
              <p className="text-xs font-semibold uppercase tracking-widest text-teal-400">FAQ</p>
              <h2 className="mt-3 text-3xl font-bold tracking-tight text-white sm:text-4xl">Questions you probably have</h2>
            </div>
        ...
        {/* ── FINAL CTA ── */}
        <section id="final-cta" className="relative overflow-hidden px-4 py-16 sm:px-6 sm:py-20 lg:px-8 lg:py-24">
          <div className="pointer-events-none absolute inset-0" aria-hidden>
          ...
          <div className="relative mx-auto max-w-3xl text-center">
            ...
            <div className="mt-10 flex flex-col items-center gap-4 sm:flex-row sm:justify-center">
              <a href="/auth" className="inline-flex min-h-[52px] w-full min-w-[200px] items-center justify-center rounded-full bg-teal-400 px-8 py-3.5 text-base font-bold text-[#0d1628] shadow-xl shadow-teal-900/30 transition hover:bg-teal-300 sm:w-auto">
      ...
      <footer className="border-t border-white/10 px-4 py-10 sm:px-6 lg:px-8">
        <div className="mx-auto flex max-w-6xl flex-col items-center gap-6 lg:flex-row lg:justify-between">
          <a href="#" className="flex items-center gap-2">
            ...
            <span className="text-base font-semibold text-white">AdonisBlue</span>
          </a>
          <nav className="flex flex-wrap justify-center gap-x-6 gap-y-2">
            {["#daily-flow|How it Works","#features|Features","#pricing|Pricing","#faq|FAQ"].map(s => {
              const [href, label] = s.split("|");
              return <a key={label} href={href} className="text-sm font-medium text-slate-400 transition hover:text-teal-300">{label}</a>;
            })}
          </nav>
          <p className="text-sm text-slate-500">© {new Date().getFullYear()} AdonisBlue. All rights reserved.</p>
        </div>
      </footer>
    </div>
  );
